...
type Country struct {
    ...
    CreatedByID   uint       `json:"created_by_id" gorm:"type:int;not null"`
    ...
    NumCode       uint       `json:"num_code" gorm:"type:integer"`
    PhoneCode     uint       `json:"phone_code" gorm:"type:integer"`
}
